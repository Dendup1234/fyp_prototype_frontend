...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={`${poppins.className} antialiased bg-[#F7FBFC] text-slate-900 min-h-screen flex flex-col`}>
        <header className="sticky top-0 z-50 border-b border-[#B9D7EA] bg-white/80 backdrop-blur">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-4">
            ...
            <nav className="hidden items-center gap-6 text-sm font-medium text-slate-600 md:flex">
              <Link href="/#pipeline" className="transition hover:text-[#769FCD]">
                How it works
              </Link>
              <Link href="/#capabilities" className="transition hover:text-[#769FCD]">
                Platform
              </Link>
              <Link href="/#automation" className="transition hover:text-[#769FCD]">
                Automations
              </Link>
              <Link href="/#proof" className="transition hover:text-[#769FCD]">
                Results
              </Link>
            </nav>
